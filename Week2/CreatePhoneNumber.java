...
public class CreatePhoneNumber{
    public static void main(String[] args) {
        ...
        System.out.printf("Using for: %s \n",CreatePhoneNumberUsingFor(number));
        System.out.printf("Using String.format: %s \n",CreatePhoneNumberUsingFor(number));
        System.out.printf("Using String.insert: %s",CreatePhoneNumberUsingStringInsert(number));
    }

    public static String CreatePhoneNumberUsingFor(int[] number) {
        String result = "(";
    ...
    public static String CreatePhoneNumberUsingStringFormat(int[] number) {
    ...
    public static StringBuilder CreatePhoneNumberUsingStringInsert(int[] number) {
